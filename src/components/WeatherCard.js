...
function formatTemperture(temperatureC) {
...
export default function WeatherCard({ weather }) {
    const hasWeather = weather && typeof weather.temperatureC === "number" && Boolean(weather.description);
                    ...
                    <div className="flex items-center gap-3">
                        {weather.iconUrl ? (
                            <Image
                                ...
                                className="h-16 w-16 object-container"
                                height={64}
                                src={weather.iconUrl}
                                width={64}
                                unoptimized
                        ...
                        <div className="flex flex-col">
                            <p className="text-3xl leading-none font-serif">
                                {formatTemperture(weather.temperatureC)}
                            </p>"
