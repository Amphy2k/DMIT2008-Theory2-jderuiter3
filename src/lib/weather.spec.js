...
import { getWeatherForProfile, getWeatherFromProfile, } from "./weather";
import { describe, expect } from "vitest";

describe("getWeatherLocationFromProfile", () => {
    it("prefers weather.location when profided", () => {
        const profile = {
...
describe("getWeatherForProfile", () => {
    ...
    it("returns a friendly message when API key is missing", async () => {
        ...
        expect(result).toEqual({
            location: "Edmonton",
            error: "Add your weather API key in local enviroment settings to show live weather.",
        });
    });
